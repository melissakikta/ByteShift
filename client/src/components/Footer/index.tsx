  ...
  return (
    ...
    style={{ textAlign: 'center', backgroundColor: "var(--secondary)", color: "var(--primary)", padding: '0px', margin: '0', width: '100vw' }}>
      ...
      <Space size="large" style={{marginTop: '10px', display: 'flex', justifyContent: 'center'}}>
        <Link className="footer-link" href="https://github.com/BlazeEMP" target="_blank" rel="noopener noreferrer"  style={{color: 'var(--primary)', fontSize: '2rem', fontFamily: 'var(--font-body)'}}>
          <strong>Dan</strong>
        ...
        <Link className="footer-link" href="https://github.com/Pizza199" target="_blank" rel="noopener noreferrer"style={{color: 'var(--primary)', fontSize: '2rem', fontFamily: 'var(--font-body)'}}>
          <strong>Steve</strong>
          <img src={github} alt="github link" style={{ width: "40px", marginLeft: "5px", marginBottom: "5px" }}/>
        </Link>
      </Space>
