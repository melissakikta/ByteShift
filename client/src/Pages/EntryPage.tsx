  ...
  return (
    <Layout className="home" style={{ minHeight: "100vh", padding: "40px", background: "var(--primary)" }}>
      <Content className="page-section" style={{ textAlign: "center", maxWidth: 800, margin: "auto" }}>
        <Title level={1} style={{ color: "var(--tertiary)", fontFamily: "var(--font-header)", fontSize: "3rem"}}>Welcome to ByteShift!</Title>
        <Row gutter={[16, 16]} justify="center">
          <Col span={24}>
            ...
            <Paragraph style={{ color: "var(--secondary)", fontFamily: "var(--font-header)", fontSize: "2.75rem"}}>
